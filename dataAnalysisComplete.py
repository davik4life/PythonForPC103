# The functionality I added was that I wrapped the entire flow in a loop
# until a condition is met to quit.
years = []
countries = []
life_expectancies = []
repeat = True
...
while repeat:
    ...
    go_again = input(
        "Would you want to enter another year to check the Data? ")
