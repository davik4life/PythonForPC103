...
if gradePercentage >= 93 or letter == "F":
    sign = ""
...
if passMark:
    print(f"Congratulation, You passed! You score is {gradePercentage}.")
else:
    print(
        f"Sorry, You did not pass. You score is {gradePercentage}. You may consider retaking the course.")
