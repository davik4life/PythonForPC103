...
# I added the option to restart the game using a while loop to provide the option to restart the game
# or not. I enjoyed the engagement of this Adventure Game.
...
while restartGameAgain:
    ...
    if choice1 == "SERVE":
        ...
        if choice2 == "AFRICA":
            ...
            print(
                "You entered the wrong input. To play this game, you must follow the set guidlines.")
    elif choice1 == "SCHOOL":
        print()
        print(
    ...
    restartGame = input("Would you love to restart the game? 'YES' or 'NO': ")
    if restartGame.upper() == "YES":
        restartGameAgain = True
    else:
        restartGameAgain = False
